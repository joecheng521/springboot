...
public class SwaggerDemoController {
	...
	@ApiOperation(value = "根据id查询订单信息", notes = "查询数据库中某个用户的订单信息")
	@ApiImplicitParam(name = "id", value = "订单ID", paramType = "path", required = true, dataType = "Long")
	@GetMapping("/order/{id}")
	public Object getSysOrderInfo(@PathVariable Long id) {
		logger.info("开始查询某个用户的订单信息");
		return iSysOrderService.findSysOrderById(id);
	}
}
