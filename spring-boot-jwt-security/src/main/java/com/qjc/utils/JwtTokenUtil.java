...
public class JwtTokenUtil {
	...
	static { // 将证书文件里边的私钥公钥拿出来
		try {
			...
			keyStore.load(inputStream, "654321".toCharArray());
			privateKey = (PrivateKey) keyStore.getKey("jwt", "654321".toCharArray()); // jwt 为 命令生成整数文件时的别名
